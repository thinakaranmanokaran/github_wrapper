                                    ...
                                    <div ref={profileRef} className="min-w-fit w-full  md:max-w-3/5 md:p-6 rounded-3xl text-center flex flex-col font-general border-2 border-neutral-300 shadow-lg p-2 py-4 bg-gradient-to-b to-white from-neutral-200 dark:text-black">
                                        <div className="md:flex items-center justify-between ">
                                            ...
                                            <div className="hidden md:flex items-center gap-6 relative">
                                                ...
                                                {/*  */}
                                                {!isUsernameInParams && <button onClick={changeBG} className={`download-btn bg-black px-8 py-3 text-white rounded-full  shadow-sm shadow-black cursor-pointer before:content-[''] before:absolute before:inset-0 before:bg-zinc-200 relative before:-rotate-45 before:-translate-x-full hover:before:translate-x-full transition-all duration-1000 before:w-40 overflow-hidden before:transition-all before:duration-[1.5s] z-20 ${bgChange ? "outline-8 outline-white" : ""}`}>Share</button>}
                                                {
